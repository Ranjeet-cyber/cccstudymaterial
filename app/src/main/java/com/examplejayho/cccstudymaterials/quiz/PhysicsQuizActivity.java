...
import com.examplejayho.cccstudymaterials.Physics.PhysicsQuestion1;
import com.examplejayho.cccstudymaterials.Physics.PhysicsQuestion10;
import com.examplejayho.cccstudymaterials.Physics.PhysicsQuestion2;
import com.examplejayho.cccstudymaterials.Physics.PhysicsQuestion3;
import com.examplejayho.cccstudymaterials.Physics.PhysicsQuestion4;
import com.examplejayho.cccstudymaterials.Physics.PhysicsQuestion5;
import com.examplejayho.cccstudymaterials.Physics.PhysicsQuestion6;
import com.examplejayho.cccstudymaterials.Physics.PhysicsQuestion7;
import com.examplejayho.cccstudymaterials.Physics.PhysicsQuestion8;
import com.examplejayho.cccstudymaterials.Physics.PhysicsQuestion9;
...
public class PhysicsQuizActivity extends AppCompatActivity {
    ...
    private PhysicsQuestion1 mQuestions1 = new PhysicsQuestion1();
    private PhysicsQuestion10 mQuestions10 = new PhysicsQuestion10();
    private PhysicsQuestion2 mQuestions2 = new PhysicsQuestion2();
    private PhysicsQuestion3 mQuestions3 = new PhysicsQuestion3();
    private PhysicsQuestion4 mQuestions4 = new PhysicsQuestion4();
    private PhysicsQuestion5 mQuestions5 = new PhysicsQuestion5();
    private PhysicsQuestion6 mQuestions6 = new PhysicsQuestion6();
    private PhysicsQuestion7 mQuestions7 = new PhysicsQuestion7();
    private PhysicsQuestion8 mQuestions8 = new PhysicsQuestion8();
    private PhysicsQuestion9 mQuestions9 = new PhysicsQuestion9();
    ...
    private static final String TAG = "PhysicsQuizActivity";
    ...
    public void onCreate(Bundle bundle) {
        ...
        String stringExtra = this.f3057i.getStringExtra("sub");
        ...
        this.answer1.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                PhysicsQuizActivity.this.lambda$onCreate$2$PhysicsQuizActivity(view);
            }
        });
        this.answer2.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                PhysicsQuizActivity.this.lambda$onCreate$5$PhysicsQuizActivity(view);
            }
        });
        this.answer3.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                PhysicsQuizActivity.this.lambda$onCreate$8$PhysicsQuizActivity(view);
            }
        });
        this.answer4.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                PhysicsQuizActivity.this.lambda$onCreate$11$PhysicsQuizActivity(view);
            }
        });
        this.bfinish.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                PhysicsQuizActivity.this.lambda$onCreate$12$PhysicsQuizActivity(view);
            }
        });
        ...
        button.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                PhysicsQuizActivity.this.lambda$onCreate$13$PhysicsQuizActivity(view);
            }
        });
        this.sharequestion.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                PhysicsQuizActivity.this.lambda$onCreate$14$PhysicsQuizActivity(view);
            }
        });
...
//                PhysicsQuizActivity.this.finish();
//            }
//        });
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$onCreate$2$PhysicsQuizActivity(View view) {
        disabledbutton();
        this.questionno++;
        if (this.answer1.getText().toString().equalsIgnoreCase(this.mAnswer)) {
            ...
            new Handler().postDelayed(new Runnable() {
                public final void run() {
                    PhysicsQuizActivity.this.lambda$null$0$PhysicsQuizActivity();
                }
            }, (long) this.time);
            return;
        }
        ...
        new Handler().postDelayed(new Runnable() {
            public final void run() {
                PhysicsQuizActivity.this.lambda$null$1$PhysicsQuizActivity();
            }
        }, (long) this.time);
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$0$PhysicsQuizActivity() {
        this.iconbtn1.setVisibility(4);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$1$PhysicsQuizActivity() {
        this.ciconbtn1.setVisibility(4);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$onCreate$5$PhysicsQuizActivity(View view) {
        disabledbutton();
        this.questionno++;
        if (this.answer2.getText().toString().equalsIgnoreCase(this.mAnswer)) {
            ...
            new Handler().postDelayed(new Runnable() {
                public final void run() {
                    PhysicsQuizActivity.this.lambda$null$3$PhysicsQuizActivity();
                }
            }, (long) this.time);
            return;
        }
        ...
        new Handler().postDelayed(new Runnable() {
            public final void run() {
                PhysicsQuizActivity.this.lambda$null$4$PhysicsQuizActivity();
            }
        }, (long) this.time);
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$3$PhysicsQuizActivity() {
        this.iconbtn2.setVisibility(4);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$4$PhysicsQuizActivity() {
        this.ciconbtn2.setVisibility(4);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$onCreate$8$PhysicsQuizActivity(View view) {
        disabledbutton();
        this.questionno++;
        if (this.answer3.getText().toString().equalsIgnoreCase(this.mAnswer)) {
            ...
            new Handler().postDelayed(new Runnable() {
                public final void run() {
                    PhysicsQuizActivity.this.lambda$null$6$PhysicsQuizActivity();
                }
            }, (long) this.time);
            return;
        }
        ...
        new Handler().postDelayed(new Runnable() {
            public final void run() {
                PhysicsQuizActivity.this.lambda$null$7$PhysicsQuizActivity();
            }
        }, (long) this.time);
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$6$PhysicsQuizActivity() {
        this.iconbtn3.setVisibility(8);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$7$PhysicsQuizActivity() {
        this.ciconbtn3.setVisibility(4);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$onCreate$11$PhysicsQuizActivity(View view) {
        disabledbutton();
        this.questionno++;
        if (this.answer4.getText().toString().equalsIgnoreCase(this.mAnswer)) {
            ...
            new Handler().postDelayed(new Runnable() {
                public final void run() {
                    PhysicsQuizActivity.this.lambda$null$9$PhysicsQuizActivity();
                }
            }, (long) this.time);
            return;
        }
        ...
        new Handler().postDelayed(new Runnable() {
            public final void run() {
                PhysicsQuizActivity.this.lambda$null$10$PhysicsQuizActivity();
            }
        }, (long) this.time);
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$9$PhysicsQuizActivity() {
        this.iconbtn4.setVisibility(8);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$10$PhysicsQuizActivity() {
        enabledbutton();
        this.ciconbtn4.setVisibility(8);
        updateQuestion(this.questionno);
    }

    public /* synthetic */ void lambda$onCreate$12$PhysicsQuizActivity(View view) {
        gameOver();
    }

    public /* synthetic */ void lambda$onCreate$13$PhysicsQuizActivity(View view) {
        int i = this.questionno + 1;
        this.questionno = i;
        updateQuestion(i);
    }

    public /* synthetic */ void lambda$onCreate$14$PhysicsQuizActivity(View view) {
    ...
    private void checkcorrectans(String str) {
        ...
        new Handler().postDelayed(new Runnable() {
            public final void run() {
                PhysicsQuizActivity.this.lambda$checkcorrectans$15$PhysicsQuizActivity();
            }
        }, (long) this.time);
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$checkcorrectans$15$PhysicsQuizActivity() {
        this.iconbtn1.setVisibility(4);
        this.iconbtn2.setVisibility(4);
    ...
    public void gameOver() {
        ...
        ((Button) inflate.findViewById(R.id.shareResult)).setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                PhysicsQuizActivity.this.lambda$gameOver$16$PhysicsQuizActivity(view);
            }
        });
        ((Button) inflate.findViewById(R.id.newQuiz)).setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                PhysicsQuizActivity.this.lambda$gameOver$17$PhysicsQuizActivity(view);
            }
        });
        ...
        ((Button) inflate.findViewById(R.id.back)).setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                PhysicsQuizActivity.this.lambda$gameOver$18$PhysicsQuizActivity(view);
            }
        });
...
//
//            public final void onClick(View view) {
//                PhysicsQuizActivity.this.lambda$gameOver$19$PhysicsQuizActivity(this.f$1, view);
//            }
//        });
        create.show();
    ...
    public /* synthetic */ void lambda$gameOver$16$PhysicsQuizActivity(View view) {
        Intent intent = new Intent("android.intent.action.SEND");
        intent.setType("text/plain");
        intent.putExtra("android.intent.extra.SUBJECT", getString(R.string.share_subject));
    ...
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$gameOver$17$PhysicsQuizActivity(View view) {
        finishAffinity();
    ...
    public /* synthetic */ void lambda$gameOver$18$PhysicsQuizActivity(View view) {
        finish();
    }

    public /* synthetic */ void lambda$gameOver$19$PhysicsQuizActivity(AlertDialog alertDialog, View view) {
        this.questionno = 0;
        this.mScore = 0;
        this.wrongans = 0;
        this.totalanswer = 0;
    ...
    public void onBackPressed() {
        if (minterstitialAd != null) {
            minterstitialAd.show(PhysicsQuizActivity.this);
        }else {
            super.onBackPressed();
            finish();
        }
