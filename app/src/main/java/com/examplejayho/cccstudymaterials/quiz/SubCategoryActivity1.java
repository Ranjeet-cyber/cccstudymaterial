...
public class SubCategoryActivity1 extends AppCompatActivity {
    private final String TAG = SubCategoryActivity1.class.getSimpleName();
    String category;
    Intent intent;
...
//        this.mAdView2 = (AdView) findViewById(C3585R.C3588id.adView2);
//        this.mAdView2.loadAd(new AdRequest.Builder().build());
    ...
    public void cardClick(View view) {
        ...
        Intent intent3 = new Intent(this, BioQuizActivity.class);
