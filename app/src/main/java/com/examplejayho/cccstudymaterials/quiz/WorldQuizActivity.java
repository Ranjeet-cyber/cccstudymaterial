...
import com.examplejayho.cccstudymaterials.World.WorldQuestion1;
import com.examplejayho.cccstudymaterials.World.WorldQuestion10;
import com.examplejayho.cccstudymaterials.World.WorldQuestion2;
import com.examplejayho.cccstudymaterials.World.WorldQuestion3;
import com.examplejayho.cccstudymaterials.World.WorldQuestion4;
import com.examplejayho.cccstudymaterials.World.WorldQuestion5;
import com.examplejayho.cccstudymaterials.World.WorldQuestion6;
import com.examplejayho.cccstudymaterials.World.WorldQuestion7;
import com.examplejayho.cccstudymaterials.World.WorldQuestion8;
import com.examplejayho.cccstudymaterials.World.WorldQuestion9;
...
public class WorldQuizActivity extends AppCompatActivity {
    Button answer1;
    Button answer2;
    Button answer3;
    Button answer4;
    ...
    private static final String TAG = "WorldQuizActivity";
    String category;
    ImageView ciconbtn1;
    ImageView ciconbtn2;
    ImageView ciconbtn3;
    ...
    public void onCreate (Bundle bundle){
        ...
        this.answer1.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                WorldQuizActivity.this.lambda$onCreate$2$WorldQuizActivity(view);
            }
        });
        this.answer2.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                WorldQuizActivity.this.lambda$onCreate$5$WorldQuizActivity(view);
            }
        });
        this.answer3.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                WorldQuizActivity.this.lambda$onCreate$8$WorldQuizActivity(view);
            }
        });
        this.answer4.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                WorldQuizActivity.this.lambda$onCreate$11$WorldQuizActivity(view);
            }
        });
        this.bfinish.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                WorldQuizActivity.this.lambda$onCreate$12$WorldQuizActivity(view);
            }
        });
        ...
        button.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                WorldQuizActivity.this.lambda$onCreate$13$WorldQuizActivity(view);
            }
        });
        this.sharequestion.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                WorldQuizActivity.this.lambda$onCreate$14$WorldQuizActivity(view);
            }
        });
    ...
    public /* synthetic */ void lambda$onCreate$2$WorldQuizActivity (View view){
        ...
        if (this.answer1.getText().toString().equalsIgnoreCase(this.mAnswer)) {
            ...
            new Handler().postDelayed(new Runnable() {
                public final void run() {
                    WorldQuizActivity.this.lambda$null$0$WorldQuizActivity();
                }
            }, (long) this.time);
            return;
        }
        ...
        new Handler().postDelayed(new Runnable() {
            public final void run() {
                WorldQuizActivity.this.lambda$null$1$WorldQuizActivity();
            }
        }, (long) this.time);
    }
    ...
    public /* synthetic */ void lambda$onCreate$5$WorldQuizActivity (View view){
        ...
        if (this.answer2.getText().toString().equalsIgnoreCase(this.mAnswer)) {
            ...
            new Handler().postDelayed(new Runnable() {
                public final void run() {
                    WorldQuizActivity.this.lambda$null$3$WorldQuizActivity();
                }
            }, (long) this.time);
            return;
        }
        ...
        new Handler().postDelayed(new Runnable() {
            public final void run() {
                WorldQuizActivity.this.lambda$null$4$WorldQuizActivity();
            }
        }, (long) this.time);
    }
    ...
    public /* synthetic */ void lambda$onCreate$8$WorldQuizActivity (View view){
        ...
        if (this.answer3.getText().toString().equalsIgnoreCase(this.mAnswer)) {
            ...
            new Handler().postDelayed(new Runnable() {
                public final void run() {
                    WorldQuizActivity.this.lambda$null$6$WorldQuizActivity();
                }
            }, (long) this.time);
            return;
        }
        ...
        new Handler().postDelayed(new Runnable() {
            public final void run() {
                WorldQuizActivity.this.lambda$null$7$WorldQuizActivity();
            }
        }, (long) this.time);
    }
    ...
    public /* synthetic */ void lambda$onCreate$11$WorldQuizActivity (View view){
        ...
        if (this.answer4.getText().toString().equalsIgnoreCase(this.mAnswer)) {
            ...
            new Handler().postDelayed(new Runnable() {
                public final void run() {
                    WorldQuizActivity.this.lambda$null$9$WorldQuizActivity();
                }
            }, (long) this.time);
            return;
        }
        ...
        new Handler().postDelayed(new Runnable() {
            public final void run() {
                WorldQuizActivity.this.lambda$null$10$WorldQuizActivity();
            }
        }, (long) this.time);
    }
    ...
    private void checkcorrectans (String str){
        ...
        new Handler().postDelayed(new Runnable() {
            public final void run() {
                WorldQuizActivity.this.lambda$checkcorrectans$15$WorldQuizActivity();
            }
        }, (long) this.time);
    }
    ...
    public void gameOver () {
        ...
        ((Button) inflate.findViewById(R.id.shareResult)).setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                WorldQuizActivity.this.lambda$gameOver$16$WorldQuizActivity(view);
            }
        });
        ((Button) inflate.findViewById(R.id.newQuiz)).setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                WorldQuizActivity.this.lambda$gameOver$17$WorldQuizActivity(view);
            }
        });
        ...
        ((Button) inflate.findViewById(R.id.back)).setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                WorldQuizActivity.this.lambda$gameOver$18$WorldQuizActivity(view);
            }
        });
        create.show();
    ...
    public void onBackPressed() {
        if (minterstitialAd != null) {
            minterstitialAd.show(WorldQuizActivity.this);
        }else {
            super.onBackPressed();
            finish();
        }
