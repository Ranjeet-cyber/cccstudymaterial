...
import com.examplejayho.cccstudymaterials.History.HistoryQuestion1;
import com.examplejayho.cccstudymaterials.History.HistoryQuestion10;
import com.examplejayho.cccstudymaterials.History.HistoryQuestion2;
import com.examplejayho.cccstudymaterials.History.HistoryQuestion3;
import com.examplejayho.cccstudymaterials.History.HistoryQuestion4;
import com.examplejayho.cccstudymaterials.History.HistoryQuestion5;
import com.examplejayho.cccstudymaterials.History.HistoryQuestion6;
import com.examplejayho.cccstudymaterials.History.HistoryQuestion7;
import com.examplejayho.cccstudymaterials.History.HistoryQuestion8;
import com.examplejayho.cccstudymaterials.History.HistoryQuestion9;
...
public class HistoryQuizActivity extends AppCompatActivity {
    ...
    private HistoryQuestion1 mQuestions1 = new HistoryQuestion1();
    private HistoryQuestion10 mQuestions10 = new HistoryQuestion10();
    private HistoryQuestion2 mQuestions2 = new HistoryQuestion2();
    private HistoryQuestion3 mQuestions3 = new HistoryQuestion3();
    private HistoryQuestion4 mQuestions4 = new HistoryQuestion4();
    private HistoryQuestion5 mQuestions5 = new HistoryQuestion5();
    private HistoryQuestion6 mQuestions6 = new HistoryQuestion6();
    private HistoryQuestion7 mQuestions7 = new HistoryQuestion7();
    private HistoryQuestion8 mQuestions8 = new HistoryQuestion8();
    private HistoryQuestion9 mQuestions9 = new HistoryQuestion9();
    ...
    private static final String TAG = "HistoryQuizActivity";
    ...
    public void onCreate(Bundle bundle) {
        ...
        String stringExtra = this.f3055i.getStringExtra("sub");
        ...
        this.answer1.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                HistoryQuizActivity.this.lambda$onCreate$2$HistoryQuizActivity(view);
            }
        });
        this.answer2.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                HistoryQuizActivity.this.lambda$onCreate$5$HistoryQuizActivity(view);
            }
        });
        this.answer3.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                HistoryQuizActivity.this.lambda$onCreate$8$HistoryQuizActivity(view);
            }
        });
        this.answer4.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                HistoryQuizActivity.this.lambda$onCreate$11$HistoryQuizActivity(view);
            }
        });
        this.bfinish.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                HistoryQuizActivity.this.lambda$onCreate$12$HistoryQuizActivity(view);
            }
        });
        ...
        button.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                HistoryQuizActivity.this.lambda$onCreate$13$HistoryQuizActivity(view);
            }
        });
        this.sharequestion.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                HistoryQuizActivity.this.lambda$onCreate$14$HistoryQuizActivity(view);
            }
        });
...
//                HistoryQuizActivity.this.finish();
//            }
//        });
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$onCreate$2$HistoryQuizActivity(View view) {
        disabledbutton();
        this.questionno++;
        if (this.answer1.getText().toString().equalsIgnoreCase(this.mAnswer)) {
            ...
            new Handler().postDelayed(new Runnable() {
                public final void run() {
                    HistoryQuizActivity.this.lambda$null$0$HistoryQuizActivity();
                }
            }, (long) this.time);
            return;
        }
        ...
        new Handler().postDelayed(new Runnable() {
            public final void run() {
                HistoryQuizActivity.this.lambda$null$1$HistoryQuizActivity();
            }
        }, (long) this.time);
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$0$HistoryQuizActivity() {
        this.iconbtn1.setVisibility(4);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$1$HistoryQuizActivity() {
        this.ciconbtn1.setVisibility(4);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$onCreate$5$HistoryQuizActivity(View view) {
        disabledbutton();
        this.questionno++;
        if (this.answer2.getText().toString().equalsIgnoreCase(this.mAnswer)) {
            ...
            new Handler().postDelayed(new Runnable() {
                public final void run() {
                    HistoryQuizActivity.this.lambda$null$3$HistoryQuizActivity();
                }
            }, (long) this.time);
            return;
        }
        ...
        new Handler().postDelayed(new Runnable() {
            public final void run() {
                HistoryQuizActivity.this.lambda$null$4$HistoryQuizActivity();
            }
        }, (long) this.time);
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$3$HistoryQuizActivity() {
        this.iconbtn2.setVisibility(4);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$4$HistoryQuizActivity() {
        this.ciconbtn2.setVisibility(4);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$onCreate$8$HistoryQuizActivity(View view) {
        disabledbutton();
        this.questionno++;
        if (this.answer3.getText().toString().equalsIgnoreCase(this.mAnswer)) {
            ...
            new Handler().postDelayed(new Runnable() {
                public final void run() {
                    HistoryQuizActivity.this.lambda$null$6$HistoryQuizActivity();
                }
            }, (long) this.time);
            return;
        }
        ...
        new Handler().postDelayed(new Runnable() {
            public final void run() {
                HistoryQuizActivity.this.lambda$null$7$HistoryQuizActivity();
            }
        }, (long) this.time);
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$6$HistoryQuizActivity() {
        this.iconbtn3.setVisibility(8);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$7$HistoryQuizActivity() {
        this.ciconbtn3.setVisibility(4);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$onCreate$11$HistoryQuizActivity(View view) {
        disabledbutton();
        this.questionno++;
        if (this.answer4.getText().toString().equalsIgnoreCase(this.mAnswer)) {
            ...
            new Handler().postDelayed(new Runnable() {
                public final void run() {
                    HistoryQuizActivity.this.lambda$null$9$HistoryQuizActivity();
                }
            }, (long) this.time);
            return;
        }
        ...
        new Handler().postDelayed(new Runnable() {
            public final void run() {
                HistoryQuizActivity.this.lambda$null$10$HistoryQuizActivity();
            }
        }, (long) this.time);
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$9$HistoryQuizActivity() {
        this.iconbtn4.setVisibility(8);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$10$HistoryQuizActivity() {
        enabledbutton();
        this.ciconbtn4.setVisibility(8);
        updateQuestion(this.questionno);
    }

    public /* synthetic */ void lambda$onCreate$12$HistoryQuizActivity(View view) {
        gameOver();
    }

    public /* synthetic */ void lambda$onCreate$13$HistoryQuizActivity(View view) {
        int i = this.questionno + 1;
        this.questionno = i;
        updateQuestion(i);
    }

    public /* synthetic */ void lambda$onCreate$14$HistoryQuizActivity(View view) {
    ...
    private void checkcorrectans(String str) {
        ...
        new Handler().postDelayed(new Runnable() {
            public final void run() {
                HistoryQuizActivity.this.lambda$checkcorrectans$15$HistoryQuizActivity();
            }
        }, (long) this.time);
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$checkcorrectans$15$HistoryQuizActivity() {
        this.iconbtn1.setVisibility(4);
        this.iconbtn2.setVisibility(4);
    ...
    public void gameOver() {
        ...
        ((Button) inflate.findViewById(R.id.shareResult)).setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                HistoryQuizActivity.this.lambda$gameOver$16$HistoryQuizActivity(view);
            }
        });
        ((Button) inflate.findViewById(R.id.newQuiz)).setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                HistoryQuizActivity.this.lambda$gameOver$17$HistoryQuizActivity(view);
            }
        });
        ...
        ((Button) inflate.findViewById(R.id.back)).setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                HistoryQuizActivity.this.lambda$gameOver$18$HistoryQuizActivity(view);
            }
        });
...
//
//            public final void onClick(View view) {
//                HistoryQuizActivity.this.lambda$gameOver$19$HistoryQuizActivity(this.f$1, view);
//            }
//        });
        create.show();
    ...
    public /* synthetic */ void lambda$gameOver$16$HistoryQuizActivity(View view) {
        Intent intent = new Intent("android.intent.action.SEND");
        intent.setType("text/plain");
        intent.putExtra("android.intent.extra.SUBJECT", getString(R.string.share_subject));
    ...
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$gameOver$17$HistoryQuizActivity(View view) {
        finishAffinity();
    ...
    public /* synthetic */ void lambda$gameOver$18$HistoryQuizActivity(View view) {
        finish();
    }

    public /* synthetic */ void lambda$gameOver$19$HistoryQuizActivity(AlertDialog alertDialog, View view) {
        this.questionno = 0;
        this.mScore = 0;
        this.wrongans = 0;
        this.totalanswer = 0;
    ...
    public void onBackPressed() {
        if (minterstitialAd != null) {
            minterstitialAd.show(HistoryQuizActivity.this);
        }else {
            super.onBackPressed();
            finish();
        }
