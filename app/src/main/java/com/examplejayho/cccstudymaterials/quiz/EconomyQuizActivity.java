...
import com.examplejayho.cccstudymaterials.Economy.EconomyQuestion1;
import com.examplejayho.cccstudymaterials.Economy.EconomyQuestion10;
import com.examplejayho.cccstudymaterials.Economy.EconomyQuestion2;
import com.examplejayho.cccstudymaterials.Economy.EconomyQuestion3;
import com.examplejayho.cccstudymaterials.Economy.EconomyQuestion4;
import com.examplejayho.cccstudymaterials.Economy.EconomyQuestion5;
import com.examplejayho.cccstudymaterials.Economy.EconomyQuestion6;
import com.examplejayho.cccstudymaterials.Economy.EconomyQuestion7;
import com.examplejayho.cccstudymaterials.Economy.EconomyQuestion8;
import com.examplejayho.cccstudymaterials.Economy.EconomyQuestion9;
...
public class EconomyQuizActivity extends AppCompatActivity {
    Button answer1;
    Button answer2;
    Button answer3;
    Button answer4;
   ...
   private AdView mAdView;
    ...
    private EconomyQuestion1 mQuestions1 = new EconomyQuestion1();
    private EconomyQuestion10 mQuestions10 = new EconomyQuestion10();
    private EconomyQuestion2 mQuestions2 = new EconomyQuestion2();
    private EconomyQuestion3 mQuestions3 = new EconomyQuestion3();
    private EconomyQuestion4 mQuestions4 = new EconomyQuestion4();
    private EconomyQuestion5 mQuestions5 = new EconomyQuestion5();
    private EconomyQuestion6 mQuestions6 = new EconomyQuestion6();
    private EconomyQuestion7 mQuestions7 = new EconomyQuestion7();
    private EconomyQuestion8 mQuestions8 = new EconomyQuestion8();
    private EconomyQuestion9 mQuestions9 = new EconomyQuestion9();
    ...
    private static final String TAG = "EconomyQuizActivity";
    ...
    public void onCreate(Bundle bundle) {
        ...
        String stringExtra = this.f3053i.getStringExtra("sub");
        ...
        this.answer1.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                EconomyQuizActivity.this.lambda$onCreate$2$EconomyQuizActivity(view);
            }
        });
        this.answer2.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                EconomyQuizActivity.this.lambda$onCreate$5$EconomyQuizActivity(view);
            }
        });
        this.answer3.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                EconomyQuizActivity.this.lambda$onCreate$8$EconomyQuizActivity(view);
            }
        });
        this.answer4.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                EconomyQuizActivity.this.lambda$onCreate$11$EconomyQuizActivity(view);
            }
        });
        this.bfinish.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                EconomyQuizActivity.this.lambda$onCreate$12$EconomyQuizActivity(view);
            }
        });
        ...
        button.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                EconomyQuizActivity.this.lambda$onCreate$13$EconomyQuizActivity(view);
            }
        });
        this.sharequestion.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                EconomyQuizActivity.this.lambda$onCreate$14$EconomyQuizActivity(view);
            }
        });
...
//                EconomyQuizActivity.this.finish();
//            }
//        });
    }

    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$onCreate$2$EconomyQuizActivity(View view) {
        disabledbutton();
        this.questionno++;
        if (this.answer1.getText().toString().equalsIgnoreCase(this.mAnswer)) {
            ...
            new Handler().postDelayed(new Runnable() {
                public final void run() {
                    EconomyQuizActivity.this.lambda$null$0$EconomyQuizActivity();
                }
            }, (long) this.time);
            return;
        }
        ...
        new Handler().postDelayed(new Runnable() {
            public final void run() {
                EconomyQuizActivity.this.lambda$null$1$EconomyQuizActivity();
            }
        }, (long) this.time);
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$0$EconomyQuizActivity() {
        this.iconbtn1.setVisibility(4);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$1$EconomyQuizActivity() {
        this.ciconbtn1.setVisibility(4);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$onCreate$5$EconomyQuizActivity(View view) {
        disabledbutton();
        this.questionno++;
        if (this.answer2.getText().toString().equalsIgnoreCase(this.mAnswer)) {
            ...
            new Handler().postDelayed(new Runnable() {
                public final void run() {
                    EconomyQuizActivity.this.lambda$null$3$EconomyQuizActivity();
                }
            }, (long) this.time);
            return;
        }
        ...
        new Handler().postDelayed(new Runnable() {
            public final void run() {
                EconomyQuizActivity.this.lambda$null$4$EconomyQuizActivity();
            }
        }, (long) this.time);
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$3$EconomyQuizActivity() {
        this.iconbtn2.setVisibility(4);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$4$EconomyQuizActivity() {
        this.ciconbtn2.setVisibility(4);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$onCreate$8$EconomyQuizActivity(View view) {
        disabledbutton();
        this.questionno++;
        if (this.answer3.getText().toString().equalsIgnoreCase(this.mAnswer)) {
            ...
            new Handler().postDelayed(new Runnable() {
                public final void run() {
                    EconomyQuizActivity.this.lambda$null$6$EconomyQuizActivity();
                }
            }, (long) this.time);
            return;
        }
        ...
        new Handler().postDelayed(new Runnable() {
            public final void run() {
                EconomyQuizActivity.this.lambda$null$7$EconomyQuizActivity();
            }
        }, (long) this.time);
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$6$EconomyQuizActivity() {
        this.iconbtn3.setVisibility(8);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$7$EconomyQuizActivity() {
        this.ciconbtn3.setVisibility(4);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$onCreate$11$EconomyQuizActivity(View view) {
        disabledbutton();
        this.questionno++;
        if (this.answer4.getText().toString().equalsIgnoreCase(this.mAnswer)) {
            ...
            new Handler().postDelayed(new Runnable() {
                public final void run() {
                    EconomyQuizActivity.this.lambda$null$9$EconomyQuizActivity();
                }
            }, (long) this.time);
            return;
        }
        ...
        new Handler().postDelayed(new Runnable() {
            public final void run() {
                EconomyQuizActivity.this.lambda$null$10$EconomyQuizActivity();
            }
        }, (long) this.time);
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$9$EconomyQuizActivity() {
        this.iconbtn4.setVisibility(8);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$10$EconomyQuizActivity() {
        enabledbutton();
        this.ciconbtn4.setVisibility(8);
        updateQuestion(this.questionno);
    }

    public /* synthetic */ void lambda$onCreate$12$EconomyQuizActivity(View view) {
        gameOver();
    }

    public /* synthetic */ void lambda$onCreate$13$EconomyQuizActivity(View view) {
        int i = this.questionno + 1;
        this.questionno = i;
        updateQuestion(i);
    }

    public /* synthetic */ void lambda$onCreate$14$EconomyQuizActivity(View view) {
    ...
    private void checkcorrectans(String str) {
        ...
        new Handler().postDelayed(new Runnable() {
            public final void run() {
                EconomyQuizActivity.this.lambda$checkcorrectans$15$EconomyQuizActivity();
            }
        }, (long) this.time);
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$checkcorrectans$15$EconomyQuizActivity() {
        this.iconbtn1.setVisibility(4);
        this.iconbtn2.setVisibility(4);
    ...
    public void gameOver() {
        ...
        ((Button) inflate.findViewById(R.id.shareResult)).setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                EconomyQuizActivity.this.lambda$gameOver$16$EconomyQuizActivity(view);
            }
        });
        ((Button) inflate.findViewById(R.id.newQuiz)).setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                EconomyQuizActivity.this.lambda$gameOver$17$EconomyQuizActivity(view);
            }
        });
        ...
        ((Button) inflate.findViewById(R.id.back)).setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                EconomyQuizActivity.this.lambda$gameOver$18$EconomyQuizActivity(view);
            }
        });
...
//
//            public final void onClick(View view) {
//                EconomyQuizActivity.this.lambda$gameOver$19$EconomyQuizActivity(this.f$1, view);
//            }
//        });
        create.show();
    ...
    public /* synthetic */ void lambda$gameOver$16$EconomyQuizActivity(View view) {
        Intent intent = new Intent("android.intent.action.SEND");
        intent.setType("text/plain");
        intent.putExtra("android.intent.extra.SUBJECT", getString(R.string.share_subject));
    ...
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$gameOver$17$EconomyQuizActivity(View view) {
        finishAffinity();
    ...
    public /* synthetic */ void lambda$gameOver$18$EconomyQuizActivity(View view) {
        finish();
    }

    public /* synthetic */ void lambda$gameOver$19$EconomyQuizActivity(AlertDialog alertDialog, View view) {
        this.questionno = 0;
        this.mScore = 0;
        this.wrongans = 0;
        this.totalanswer = 0;
    ...
    public void onBackPressed() {
        if (minterstitialAd != null) {
            minterstitialAd.show(EconomyQuizActivity.this);
        }else {
            super.onBackPressed();
            finish();
        }
