...
public class SubCategoryActivity5 extends AppCompatActivity {
    private final String TAG = SubCategoryActivity5.class.getSimpleName();
    String category;
    Intent intent;
...
//    private AdView mAdView2;
    ...
    public void cardClick(View view) {
        ...
        Intent intent3 = new Intent(this, HistoryQuizActivity.class);
