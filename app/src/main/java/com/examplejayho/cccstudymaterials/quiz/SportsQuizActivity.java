...
import com.examplejayho.cccstudymaterials.Sports.SportQuestion1;
import com.examplejayho.cccstudymaterials.Sports.SportQuestion10;
import com.examplejayho.cccstudymaterials.Sports.SportQuestion2;
import com.examplejayho.cccstudymaterials.Sports.SportQuestion3;
import com.examplejayho.cccstudymaterials.Sports.SportQuestion4;
import com.examplejayho.cccstudymaterials.Sports.SportQuestion5;
import com.examplejayho.cccstudymaterials.Sports.SportQuestion6;
import com.examplejayho.cccstudymaterials.Sports.SportQuestion7;
import com.examplejayho.cccstudymaterials.Sports.SportQuestion8;
import com.examplejayho.cccstudymaterials.Sports.SportQuestion9;
...
public class SportsQuizActivity extends AppCompatActivity {
    ...
    private SportQuestion1 mQuestions1 = new SportQuestion1();
    private SportQuestion10 mQuestions10 = new SportQuestion10();
    private SportQuestion2 mQuestions2 = new SportQuestion2();
    private SportQuestion3 mQuestions3 = new SportQuestion3();
    private SportQuestion4 mQuestions4 = new SportQuestion4();
    private SportQuestion5 mQuestions5 = new SportQuestion5();
    private SportQuestion6 mQuestions6 = new SportQuestion6();
    private SportQuestion7 mQuestions7 = new SportQuestion7();
    private SportQuestion8 mQuestions8 = new SportQuestion8();
    private SportQuestion9 mQuestions9 = new SportQuestion9();
    ...
    private static final String TAG = "SportsQuizActivity";
    ...
    public void onCreate(Bundle bundle) {
        ...
        String stringExtra = this.f3059i.getStringExtra("sub");
        ...
        this.answer1.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                SportsQuizActivity.this.lambda$onCreate$2$SportsQuizActivity(view);
            }
        });
        this.answer2.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                SportsQuizActivity.this.lambda$onCreate$5$SportsQuizActivity(view);
            }
        });
        this.answer3.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                SportsQuizActivity.this.lambda$onCreate$8$SportsQuizActivity(view);
            }
        });
        this.answer4.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                SportsQuizActivity.this.lambda$onCreate$11$SportsQuizActivity(view);
            }
        });
        this.bfinish.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                SportsQuizActivity.this.lambda$onCreate$12$SportsQuizActivity(view);
            }
        });
        ...
        button.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                SportsQuizActivity.this.lambda$onCreate$13$SportsQuizActivity(view);
            }
        });
        this.sharequestion.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                SportsQuizActivity.this.lambda$onCreate$14$SportsQuizActivity(view);
            }
        });
...
//                SportsQuizActivity.this.finish();
//            }
//        });
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$onCreate$2$SportsQuizActivity(View view) {
        disabledbutton();
        this.questionno++;
        if (this.answer1.getText().toString().equalsIgnoreCase(this.mAnswer)) {
            ...
            new Handler().postDelayed(new Runnable() {
                public final void run() {
                    SportsQuizActivity.this.lambda$null$0$SportsQuizActivity();
                }
            }, (long) this.time);
            return;
        }
        ...
        new Handler().postDelayed(new Runnable() {
            public final void run() {
                SportsQuizActivity.this.lambda$null$1$SportsQuizActivity();
            }
        }, (long) this.time);
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$0$SportsQuizActivity() {
        this.iconbtn1.setVisibility(4);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$1$SportsQuizActivity() {
        this.ciconbtn1.setVisibility(4);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$onCreate$5$SportsQuizActivity(View view) {
        disabledbutton();
        this.questionno++;
        if (this.answer2.getText().toString().equalsIgnoreCase(this.mAnswer)) {
            ...
            new Handler().postDelayed(new Runnable() {
                public final void run() {
                    SportsQuizActivity.this.lambda$null$3$SportsQuizActivity();
                }
            }, (long) this.time);
            return;
        }
        ...
        new Handler().postDelayed(new Runnable() {
            public final void run() {
                SportsQuizActivity.this.lambda$null$4$SportsQuizActivity();
            }
        }, (long) this.time);
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$3$SportsQuizActivity() {
        this.iconbtn2.setVisibility(4);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$4$SportsQuizActivity() {
        this.ciconbtn2.setVisibility(4);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$onCreate$8$SportsQuizActivity(View view) {
        disabledbutton();
        this.questionno++;
        if (this.answer3.getText().toString().equalsIgnoreCase(this.mAnswer)) {
            ...
            new Handler().postDelayed(new Runnable() {
                public final void run() {
                    SportsQuizActivity.this.lambda$null$6$SportsQuizActivity();
                }
            }, (long) this.time);
            return;
        }
        ...
        new Handler().postDelayed(new Runnable() {
            public final void run() {
                SportsQuizActivity.this.lambda$null$7$SportsQuizActivity();
            }
        }, (long) this.time);
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$6$SportsQuizActivity() {
        this.iconbtn3.setVisibility(8);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$7$SportsQuizActivity() {
        this.ciconbtn3.setVisibility(4);
        updateQuestion(this.questionno);
        enabledbutton();
    }   @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$onCreate$11$SportsQuizActivity(View view) {
        disabledbutton();
        this.questionno++;
        if (this.answer4.getText().toString().equalsIgnoreCase(this.mAnswer)) {
            ...
            new Handler().postDelayed(new Runnable() {
                public final void run() {
                    SportsQuizActivity.this.lambda$null$9$SportsQuizActivity();
                }
            }, (long) this.time);
            return;
        }
        ...
        new Handler().postDelayed(new Runnable() {
            public final void run() {
                SportsQuizActivity.this.lambda$null$10$SportsQuizActivity();
            }
        }, (long) this.time);
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$9$SportsQuizActivity() {
        this.iconbtn4.setVisibility(8);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$10$SportsQuizActivity() {
        enabledbutton();
        this.ciconbtn4.setVisibility(8);
        updateQuestion(this.questionno);
    }

    public /* synthetic */ void lambda$onCreate$12$SportsQuizActivity(View view) {
        gameOver();
    }

    public /* synthetic */ void lambda$onCreate$13$SportsQuizActivity(View view) {
        int i = this.questionno + 1;
        this.questionno = i;
        updateQuestion(i);
    }

    public /* synthetic */ void lambda$onCreate$14$SportsQuizActivity(View view) {
    ...
    private void checkcorrectans(String str) {
        ...
        new Handler().postDelayed(new Runnable() {
            public final void run() {
                SportsQuizActivity.this.lambda$checkcorrectans$15$SportsQuizActivity();
            }
        }, (long) this.time);
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$checkcorrectans$15$SportsQuizActivity() {
        this.iconbtn1.setVisibility(4);
        this.iconbtn2.setVisibility(4);
    ...
    public void gameOver() {
        ...
        ((Button) inflate.findViewById(R.id.shareResult)).setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                SportsQuizActivity.this.lambda$gameOver$16$SportsQuizActivity(view);
            }
        });
        ((Button) inflate.findViewById(R.id.newQuiz)).setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                SportsQuizActivity.this.lambda$gameOver$17$SportsQuizActivity(view);
            }
        });
        ...
        ((Button) inflate.findViewById(R.id.back)).setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                SportsQuizActivity.this.lambda$gameOver$18$SportsQuizActivity(view);
            }
        });
...
//
//            public final void onClick(View view) {
//                SportsQuizActivity.this.lambda$gameOver$19$SportsQuizActivity(this.f$1, view);
//            }
//        });
        create.show();
    ...
    public /* synthetic */ void lambda$gameOver$16$SportsQuizActivity(View view) {
        Intent intent = new Intent("android.intent.action.SEND");
        intent.setType("text/plain");
        intent.putExtra("android.intent.extra.SUBJECT", getString(R.string.share_subject));
    ...
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$gameOver$17$SportsQuizActivity(View view) {
        finishAffinity();
    ...
    public /* synthetic */ void lambda$gameOver$18$SportsQuizActivity(View view) {
        finish();
    }

    public /* synthetic */ void lambda$gameOver$19$SportsQuizActivity(AlertDialog alertDialog, View view) {
        this.questionno = 0;
        this.mScore = 0;
        this.wrongans = 0;
        this.totalanswer = 0;
    ...
    public void onBackPressed() {
        if (minterstitialAd != null) {
            minterstitialAd.show(SportsQuizActivity.this);
        }else {
            super.onBackPressed();
            finish();
        }
