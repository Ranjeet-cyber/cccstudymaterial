...
import com.examplejayho.cccstudymaterials.Geo.GeoQuestion1;
import com.examplejayho.cccstudymaterials.Geo.GeoQuestion10;
import com.examplejayho.cccstudymaterials.Geo.GeoQuestion2;
import com.examplejayho.cccstudymaterials.Geo.GeoQuestion3;
import com.examplejayho.cccstudymaterials.Geo.GeoQuestion4;
import com.examplejayho.cccstudymaterials.Geo.GeoQuestion5;
import com.examplejayho.cccstudymaterials.Geo.GeoQuestion6;
import com.examplejayho.cccstudymaterials.Geo.GeoQuestion7;
import com.examplejayho.cccstudymaterials.Geo.GeoQuestion8;
import com.examplejayho.cccstudymaterials.Geo.GeoQuestion9;
...
public class GeoQuizActivity extends AppCompatActivity {
    ...
    private GeoQuestion1 mQuestions1 = new GeoQuestion1();
    private GeoQuestion10 mQuestions10 = new GeoQuestion10();
    private GeoQuestion2 mQuestions2 = new GeoQuestion2();
    private GeoQuestion3 mQuestions3 = new GeoQuestion3();
    private GeoQuestion4 mQuestions4 = new GeoQuestion4();
    private GeoQuestion5 mQuestions5 = new GeoQuestion5();
    private GeoQuestion6 mQuestions6 = new GeoQuestion6();
    private GeoQuestion7 mQuestions7 = new GeoQuestion7();
    private GeoQuestion8 mQuestions8 = new GeoQuestion8();
    private GeoQuestion9 mQuestions9 = new GeoQuestion9();
    ...
    public void onCreate(Bundle bundle) {
        ...
        String stringExtra = this.f3054i.getStringExtra("sub");
        ...
        this.answer1.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                GeoQuizActivity.this.lambda$onCreate$2$GeoQuizActivity(view);
            }
        });
        this.answer2.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                GeoQuizActivity.this.lambda$onCreate$5$GeoQuizActivity(view);
            }
        });
        this.answer3.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                GeoQuizActivity.this.lambda$onCreate$8$GeoQuizActivity(view);
            }
        });
        this.answer4.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                GeoQuizActivity.this.lambda$onCreate$11$GeoQuizActivity(view);
            }
        });
        this.bfinish.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                GeoQuizActivity.this.lambda$onCreate$12$GeoQuizActivity(view);
            }
        });
        ...
        button.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                GeoQuizActivity.this.lambda$onCreate$13$GeoQuizActivity(view);
            }
        });
        this.sharequestion.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                GeoQuizActivity.this.lambda$onCreate$14$GeoQuizActivity(view);
            }
        });
...
//                GeoQuizActivity.this.finish();
//            }
//        });
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$onCreate$2$GeoQuizActivity(View view) {
        disabledbutton();
        this.questionno++;
        if (this.answer1.getText().toString().equalsIgnoreCase(this.mAnswer)) {
            ...
            new Handler().postDelayed(new Runnable() {
                public final void run() {
                    GeoQuizActivity.this.lambda$null$0$GeoQuizActivity();
                }
            }, (long) this.time);
            return;
        }
        ...
        new Handler().postDelayed(new Runnable() {
            public final void run() {
                GeoQuizActivity.this.lambda$null$1$GeoQuizActivity();
            }
        }, (long) this.time);
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$0$GeoQuizActivity() {
        this.iconbtn1.setVisibility(4);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$1$GeoQuizActivity() {
        this.ciconbtn1.setVisibility(4);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$onCreate$5$GeoQuizActivity(View view) {
        disabledbutton();
        this.questionno++;
        if (this.answer2.getText().toString().equalsIgnoreCase(this.mAnswer)) {
            ...
            new Handler().postDelayed(new Runnable() {
                public final void run() {
                    GeoQuizActivity.this.lambda$null$3$GeoQuizActivity();
                }
            }, (long) this.time);
            return;
        }
        ...
        new Handler().postDelayed(new Runnable() {
            public final void run() {
                GeoQuizActivity.this.lambda$null$4$GeoQuizActivity();
            }
        }, (long) this.time);
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$3$GeoQuizActivity() {
        this.iconbtn2.setVisibility(4);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$4$GeoQuizActivity() {
        this.ciconbtn2.setVisibility(4);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$onCreate$8$GeoQuizActivity(View view) {
        disabledbutton();
        this.questionno++;
        if (this.answer3.getText().toString().equalsIgnoreCase(this.mAnswer)) {
            ...
            new Handler().postDelayed(new Runnable() {
                public final void run() {
                    GeoQuizActivity.this.lambda$null$6$GeoQuizActivity();
                }
            }, (long) this.time);
            return;
        }
        ...
        new Handler().postDelayed(new Runnable() {
            public final void run() {
                GeoQuizActivity.this.lambda$null$7$GeoQuizActivity();
            }
        }, (long) this.time);
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$6$GeoQuizActivity() {
        this.iconbtn3.setVisibility(8);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$7$GeoQuizActivity() {
        this.ciconbtn3.setVisibility(4);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$onCreate$11$GeoQuizActivity(View view) {
        disabledbutton();
        this.questionno++;
        if (this.answer4.getText().toString().equalsIgnoreCase(this.mAnswer)) {
            ...
            new Handler().postDelayed(new Runnable() {
                public final void run() {
                    GeoQuizActivity.this.lambda$null$9$GeoQuizActivity();
                }
            }, (long) this.time);
            return;
        }
        ...
        new Handler().postDelayed(new Runnable() {
            public final void run() {
                GeoQuizActivity.this.lambda$null$10$GeoQuizActivity();
            }
        }, (long) this.time);
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$9$GeoQuizActivity() {
        this.iconbtn4.setVisibility(8);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$10$GeoQuizActivity() {
        enabledbutton();
        this.ciconbtn4.setVisibility(8);
        updateQuestion(this.questionno);
    }

    public /* synthetic */ void lambda$onCreate$12$GeoQuizActivity(View view) {
        gameOver();
    }

    public /* synthetic */ void lambda$onCreate$13$GeoQuizActivity(View view) {
        int i = this.questionno + 1;
        this.questionno = i;
        updateQuestion(i);
    }

    public /* synthetic */ void lambda$onCreate$14$GeoQuizActivity(View view) {
    ...
    private void checkcorrectans(String str) {
        ...
        new Handler().postDelayed(new Runnable() {
            public final void run() {
                GeoQuizActivity.this.lambda$checkcorrectans$15$GeoQuizActivity();
            }
        }, (long) this.time);
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$checkcorrectans$15$GeoQuizActivity() {
        this.iconbtn1.setVisibility(4);
        this.iconbtn2.setVisibility(4);
    ...
    public void gameOver() {
        ...
        ((Button) inflate.findViewById(R.id.shareResult)).setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                GeoQuizActivity.this.lambda$gameOver$16$GeoQuizActivity(view);
            }
        });
        ((Button) inflate.findViewById(R.id.newQuiz)).setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                GeoQuizActivity.this.lambda$gameOver$17$GeoQuizActivity(view);
            }
        });
        ...
        ((Button) inflate.findViewById(R.id.back)).setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                GeoQuizActivity.this.lambda$gameOver$18$GeoQuizActivity(view);
            }
        });
...
//
//            public final void onClick(View view) {
//                GeoQuizActivity.this.lambda$gameOver$19$GeoQuizActivity(this.f$1, view);
//            }
//        });
        create.show();
    ...
    public /* synthetic */ void lambda$gameOver$16$GeoQuizActivity(View view) {
        Intent intent = new Intent("android.intent.action.SEND");
        intent.setType("text/plain");
        intent.putExtra("android.intent.extra.SUBJECT", getString(R.string.share_subject));
    ...
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$gameOver$17$GeoQuizActivity(View view) {
        finishAffinity();
    ...
    public /* synthetic */ void lambda$gameOver$18$GeoQuizActivity(View view) {
        finish();
    }

    public /* synthetic */ void lambda$gameOver$19$GeoQuizActivity(AlertDialog alertDialog, View view) {
        this.questionno = 0;
        this.mScore = 0;
        this.wrongans = 0;
        this.totalanswer = 0;
    ...
    public void onBackPressed() {
        if (minterstitialAd != null) {
            minterstitialAd.show(GeoQuizActivity.this);
        }else {
            super.onBackPressed();
            finish();
        }
