...
import com.examplejayho.cccstudymaterials.Politics.PoliticsQuestion1;
import com.examplejayho.cccstudymaterials.Politics.PoliticsQuestion10;
import com.examplejayho.cccstudymaterials.Politics.PoliticsQuestion2;
import com.examplejayho.cccstudymaterials.Politics.PoliticsQuestion3;
import com.examplejayho.cccstudymaterials.Politics.PoliticsQuestion4;
import com.examplejayho.cccstudymaterials.Politics.PoliticsQuestion5;
import com.examplejayho.cccstudymaterials.Politics.PoliticsQuestion6;
import com.examplejayho.cccstudymaterials.Politics.PoliticsQuestion7;
import com.examplejayho.cccstudymaterials.Politics.PoliticsQuestion8;
import com.examplejayho.cccstudymaterials.Politics.PoliticsQuestion9;
...
public class PoliticsQuizActivity extends AppCompatActivity {
    Button answer1;
    Button answer2;
    Button answer3;
    Button answer4;
    ...
    private PoliticsQuestion1 mQuestions1 = new PoliticsQuestion1();
    private PoliticsQuestion10 mQuestions10 = new PoliticsQuestion10();
    private PoliticsQuestion2 mQuestions2 = new PoliticsQuestion2();
    private PoliticsQuestion3 mQuestions3 = new PoliticsQuestion3();
    private PoliticsQuestion4 mQuestions4 = new PoliticsQuestion4();
    private PoliticsQuestion5 mQuestions5 = new PoliticsQuestion5();
    private PoliticsQuestion6 mQuestions6 = new PoliticsQuestion6();
    private PoliticsQuestion7 mQuestions7 = new PoliticsQuestion7();
    private PoliticsQuestion8 mQuestions8 = new PoliticsQuestion8();
    private PoliticsQuestion9 mQuestions9 = new PoliticsQuestion9();
    ...
    private static final String TAG = "PoliticsQuizActivity";
    ...
    public void onCreate(Bundle bundle) {
        ...
        String stringExtra = this.f3058i.getStringExtra("sub");
        ...
        this.answer1.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                PoliticsQuizActivity.this.lambda$onCreate$2$PoliticsQuizActivity(view);
            }
        });
        this.answer2.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                PoliticsQuizActivity.this.lambda$onCreate$5$PoliticsQuizActivity(view);
            }
        });
        this.answer3.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                PoliticsQuizActivity.this.lambda$onCreate$8$PoliticsQuizActivity(view);
            }
        });
        this.answer4.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                PoliticsQuizActivity.this.lambda$onCreate$11$PoliticsQuizActivity(view);
            }
        });
        this.bfinish.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                PoliticsQuizActivity.this.lambda$onCreate$12$PoliticsQuizActivity(view);
            }
        });
        ...
        button.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                PoliticsQuizActivity.this.lambda$onCreate$13$PoliticsQuizActivity(view);
            }
        });
        this.sharequestion.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                PoliticsQuizActivity.this.lambda$onCreate$14$PoliticsQuizActivity(view);
            }
        });
...
//                PoliticsQuizActivity.this.finish();
//            }
//        });
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$onCreate$2$PoliticsQuizActivity(View view) {
        disabledbutton();
        this.questionno++;
        if (this.answer1.getText().toString().equalsIgnoreCase(this.mAnswer)) {
            ...
            new Handler().postDelayed(new Runnable() {
                public final void run() {
                    PoliticsQuizActivity.this.lambda$null$0$PoliticsQuizActivity();
                }
            }, (long) this.time);
            return;
        }
        ...
        new Handler().postDelayed(new Runnable() {
            public final void run() {
                PoliticsQuizActivity.this.lambda$null$1$PoliticsQuizActivity();
            }
        }, (long) this.time);
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$0$PoliticsQuizActivity() {
        this.iconbtn1.setVisibility(4);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$1$PoliticsQuizActivity() {
        this.ciconbtn1.setVisibility(4);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$onCreate$5$PoliticsQuizActivity(View view) {
        disabledbutton();
        this.questionno++;
        if (this.answer2.getText().toString().equalsIgnoreCase(this.mAnswer)) {
            ...
            new Handler().postDelayed(new Runnable() {
                public final void run() {
                    PoliticsQuizActivity.this.lambda$null$3$PoliticsQuizActivity();
                }
            }, (long) this.time);
            return;
        }
        ...
        new Handler().postDelayed(new Runnable() {
            public final void run() {
                PoliticsQuizActivity.this.lambda$null$4$PoliticsQuizActivity();
            }
        }, (long) this.time);
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$3$PoliticsQuizActivity() {
        this.iconbtn2.setVisibility(4);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$4$PoliticsQuizActivity() {
        this.ciconbtn2.setVisibility(4);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$onCreate$8$PoliticsQuizActivity(View view) {
        disabledbutton();
        this.questionno++;
        if (this.answer3.getText().toString().equalsIgnoreCase(this.mAnswer)) {
            ...
            new Handler().postDelayed(new Runnable() {
                public final void run() {
                    PoliticsQuizActivity.this.lambda$null$6$PoliticsQuizActivity();
                }
            }, (long) this.time);
            return;
        }
        ...
        new Handler().postDelayed(new Runnable() {
            public final void run() {
                PoliticsQuizActivity.this.lambda$null$7$PoliticsQuizActivity();
            }
        }, (long) this.time);
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$6$PoliticsQuizActivity() {
        this.iconbtn3.setVisibility(8);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$7$PoliticsQuizActivity() {
        this.ciconbtn3.setVisibility(4);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$onCreate$11$PoliticsQuizActivity(View view) {
        disabledbutton();
        this.questionno++;
        if (this.answer4.getText().toString().equalsIgnoreCase(this.mAnswer)) {
            ...
            new Handler().postDelayed(new Runnable() {
                public final void run() {
                    PoliticsQuizActivity.this.lambda$null$9$PoliticsQuizActivity();
                }
            }, (long) this.time);
            return;
        }
        ...
        new Handler().postDelayed(new Runnable() {
            public final void run() {
                PoliticsQuizActivity.this.lambda$null$10$PoliticsQuizActivity();
            }
        }, (long) this.time);
    }

    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$9$PoliticsQuizActivity() {
        this.iconbtn4.setVisibility(8);
        updateQuestion(this.questionno);
        enabledbutton();
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$null$10$PoliticsQuizActivity() {
        enabledbutton();
        this.ciconbtn4.setVisibility(8);
        updateQuestion(this.questionno);
    }

    public /* synthetic */ void lambda$onCreate$12$PoliticsQuizActivity(View view) {
        gameOver();
    }

    public /* synthetic */ void lambda$onCreate$13$PoliticsQuizActivity(View view) {
        int i = this.questionno + 1;
        this.questionno = i;
        updateQuestion(i);
    }

    public /* synthetic */ void lambda$onCreate$14$PoliticsQuizActivity(View view) {
    ...
    private void checkcorrectans(String str) {
        ...
        new Handler().postDelayed(new Runnable() {
            public final void run() {
                PoliticsQuizActivity.this.lambda$checkcorrectans$15$PoliticsQuizActivity();
            }
        }, (long) this.time);
    }
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$checkcorrectans$15$PoliticsQuizActivity() {
        this.iconbtn1.setVisibility(4);
        this.iconbtn2.setVisibility(4);
    ...
    public void gameOver() {
        ...
        ((Button) inflate.findViewById(R.id.shareResult)).setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                PoliticsQuizActivity.this.lambda$gameOver$16$PoliticsQuizActivity(view);
            }
        });
        ((Button) inflate.findViewById(R.id.newQuiz)).setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                PoliticsQuizActivity.this.lambda$gameOver$17$PoliticsQuizActivity(view);
            }
        });
        ...
        ((Button) inflate.findViewById(R.id.back)).setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                PoliticsQuizActivity.this.lambda$gameOver$18$PoliticsQuizActivity(view);
            }
        });
...
//
//            public final void onClick(View view) {
//                PoliticsQuizActivity.this.lambda$gameOver$19$PoliticsQuizActivity(this.f$1, view);
//            }
//        });
        create.show();
    ...
    public /* synthetic */ void lambda$gameOver$16$PoliticsQuizActivity(View view) {
        Intent intent = new Intent("android.intent.action.SEND");
        intent.setType("text/plain");
        intent.putExtra("android.intent.extra.SUBJECT", getString(R.string.share_subject));
    ...
    @SuppressLint("WrongConstant")
    public /* synthetic */ void lambda$gameOver$17$PoliticsQuizActivity(View view) {
        finishAffinity();
    ...
    public /* synthetic */ void lambda$gameOver$18$PoliticsQuizActivity(View view) {
        finish();
    }

    public /* synthetic */ void lambda$gameOver$19$PoliticsQuizActivity(AlertDialog alertDialog, View view) {
        this.questionno = 0;
        this.mScore = 0;
        this.wrongans = 0;
        this.totalanswer = 0;
    ...
    public void onBackPressed() {
        if (minterstitialAd != null) {
            minterstitialAd.show(PoliticsQuizActivity.this);
        }else {
            super.onBackPressed();
            finish();
        }
