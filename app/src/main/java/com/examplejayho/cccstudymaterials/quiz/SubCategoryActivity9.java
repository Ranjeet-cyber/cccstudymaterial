...
public class SubCategoryActivity9 extends AppCompatActivity {
    private final String TAG = SubCategoryActivity9.class.getSimpleName();
    String category;
    Intent intent;
...
//    private AdView mAdView2;
    ...
    public void cardClick(View view) {
        ...
        Intent intent3 = new Intent(this, SportsQuizActivity.class);
